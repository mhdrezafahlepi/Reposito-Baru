...
<body class="hold-transition login-page"
    ...
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('img/logosiakad.jpg') }}" width="100%" alt="">
        </div>
    ...
    @error('id_card')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMKN 3 PADANG !");
        </script>
    @enderror
    @error('guru')
        <script>
    ...
    @error('no_induk')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMKN 3 PADANG !");
        </script>
    @enderror
    @error('siswa')
        <script>
